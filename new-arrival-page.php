...
<head>
  ...
  <title>Bookoo | New Arrival</title>
  ...
  <header>
    ...
    <section class="category-container">
      <div class="category-list">
        <a class="category-tab" href="homepage.php">Home</a>
        <a class="category-tab active" href="new-arrival-page.php">New Arrival</a>
      ...
      <div class="searchbar-container">
        ...
        <div class="page-title">New Arrival</div>
        <div class="row">
          <div class="column">
            ...
            <div class="content-button">
              <button class="buynow-button" type="submit">Buy now</button>
              <button class="addtocart-button" type="submit">Add to cart</button>
            </div>
          </div>
          <div class="column">
            <div class="detail-text">
